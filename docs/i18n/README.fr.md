...
- Chaque routine tourne dans **son propre terminal attaché à sa ligne**, visible tant que le processus vit — parfait pour `npm run dev` — avec **indicateur d'exécution** et bouton d'arrêt ;
...
- **6 langues** : Português (BR), English, 中文, हिन्दी, Español et Français — interface et zone de notification ;
